      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {data && !loading && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
             ...
             {/* --- SGPA BUTTON TILE (Visible only after upload) --- */}
             <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                <div>
                    ...
                    <p className="text-xs text-slate-500">Generate SGPA list for regular students (2024 Scheme only)</p>
                </div>
                <button 
                    onClick={() => is2024Scheme && setSgpaModalOpen(true)}
                    disabled={!is2024Scheme}
                    className={`flex items-center gap-2 text-white px-5 py-2.5 rounded-lg font-bold shadow-md transition transform w-full sm:w-auto justify-center ${
                      is2024Scheme 
                        ? "bg-gradient-to-r from-emerald-500 to-green-600 hover:shadow-lg hover:from-emerald-600 hover:to-green-700 hover:-translate-y-0.5" 
                ...
                >
                    ...
                    {is2024Scheme 
                        ? "View/Export SGPA" 
                        : "Available for 2024 Scheme Only"
                    }
                </button>
             </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border border-slate-100">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">HOD, Department of CSE DATA SCIENCE, IESCE</p>
                                </div>
                                <div className="flex gap-2">
                                    <a href="#" className="p-1.5 text-slate-400 hover:text-indigo-600 transition"><Globe className="w-4 h-4" /></a>
                                </div>
